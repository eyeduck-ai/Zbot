...
import { Receipt, Play, ChevronDown, ChevronUp, Check, AlertCircle, Loader2 } from 'lucide-react';
                    ...
                    <div className="flex items-end justify-between mb-2">
                        <div className="flex items-center gap-4">
                            <div style={{
                                ...
                                <Receipt size={24} color="#137fec" />
                            </div>
                            <div>
                                <h2 className="text-2xl font-bold text-gray-900 tracking-tight">費用統計</h2>
                                <p className="text-sm text-gray-500">查詢費用碼績效 → 統計 → 更新 Google Sheet</p>
                            </div>
                        </div>
                        {/* 信任徽章 */}
                        {!loading && stats && stats.total_items > 0 && (
                            <TrustBadge taskId="stats_fee_update" totalItems={stats.total_items} />
                        )}
                    </div>
                </header>
                    ...
                    <div className="mb-6">
                        ...
                        {useCustomRange && (
                            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 space-y-4">
                                ...
                                <p className="text-xs text-amber-600 ml-14 flex items-center gap-1 mt-1">
                                    <AlertCircle size={12} />
                                    最晚只能取得上個月的數據
                                </p>
                            </div>
